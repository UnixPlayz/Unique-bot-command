...
client.on("message", async message =>{
  ...
  {
    message.channel.send(`whats my name? i am glitch :D`)
  }
});
client.on("message", async message =>{
  if (message.content.startsWith("invite"))
  {
    message.channel.send(`wanna invite me ? here's the link https://discord.com/oauth2/authorize?client_id=887293920126574613&scope=applications.commands%20bot&permissions=8`)
  }
});
client.on("message", async message =>{
